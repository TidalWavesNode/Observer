...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='obsr.conf'
CONFIGFOLDER='/root/.obsr'
COIN_DAEMON='/usr/local/bin/obsrd'
COIN_CLI='/usr/local/bin/obsr-cli'
COIN_REPO='https://github.com/observernet/obsr/releases/download/v1.0.1/obsr-1.0.1-x86_64-linux-gnu.tar.gz'
COIN_NAME='Observer'
COIN_RPC=9568
COIN_PORT=9567
